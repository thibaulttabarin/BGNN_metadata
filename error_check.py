...
for key in metadata:
    ...
    if missing_fish_change or missing_scale_change or multiple_fish_change or missing_ruler_change or missing_eye_change:
...
if __name__ == "__main__":
    ...
    data = {
        ...
        'Multiple Fish': multiple_fish_count,
