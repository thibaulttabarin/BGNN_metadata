...
species, habitats and ecosystems, and for food the industry, in the
...
fish image analysis followed the general trends in the field.
Hu et al.~\cite{HuJing2012Fscb} presented a method of classifying species
of fish based on color and texture features and used a multi-class support
...
Component Analysis, and derived a linear model from these four features
...
extracted by the CNN in supervised deep learning. They achieved 90\%
accuracy on challenging underwater digital images.
...
3D Segmentation from microCT\newline
Bock 2018 \cite{BockAlexander2018TITE},

Computer Vision Overviews Related to Fish\newline
G{\"u}m{\"u}\c{s} 2011 \cite{Gm2011MachineVA},
...
Shah 2019 \cite{Shah2019FishPakFS},
