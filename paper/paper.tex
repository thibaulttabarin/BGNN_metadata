...
Network (CNN), data fitting, and ruler detection/measurement
...
measurement by machine visions efforts.
...
the images.
Tappi et al.~\cite{Tappi2017ComputerVS} assees the freshness of frozen
