...
Digitized specimen accessible in open access repositories provide a rich,
...
The overall goal of our work addresses this need by combining
machine-learning and image informatics techniques to produce a computational
...
methods collectively provide a novel approach to computing higher-level
metadata that will support further scientific inquiry.


% [WHAT'S THE DIFFERENCE BETWEEN A GOAL AND AN OBJECTIVE?]

Four key objectives are to:
...
Pilot testing found the detectron under-segmented the detected objects
...
\begin{enumerate}
\item
Identify the appropriate threshold value for more accurate mask.
...
\item
Compute more accurate bounding box from updated mask.
