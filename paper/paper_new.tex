...
1) Test [*Explore, Demonstrate the us of] Facebook's AI Research's dectectron tool
Specific aims are to use dectectron to identify five object classes: fish, fish eyes, rulers, and the numbers 2 and 3 on rulers, as shown in Figure 2.
2) Pursue [*Investigate] image processing at the pixel level.
...
3) Compute [Test our ability to calculate] the following higher-level metadata properties: 
1) contrast (intensities of
the foreground and background, 2) centroid and eye center, and if eye is found, the fish 3) side 4) primary axis and clock value, finally the 5) scale and length.
