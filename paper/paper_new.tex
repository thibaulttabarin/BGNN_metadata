...
Methods that  combine ML and image informatics techniques allow us to rapidly enrich the existing metadata associated with each of 
7,244 images from the Illinois Natural History Survey (INHS). The sample
images all have 22 manually generated metadata properties associated with them, which
aid our study.  Results show we can accurately generate many key metadata properties relevant to the
...
specimens in ML. This research has implications for harnessing the tens of thousands of digitized specimens stored in open-access repositories found wold-wide.
