...
\todo{Not sure if I can phrase it that way or not since I haven't looked at all the images to see if the ruler itself was found or something else was labeled a ruler} In 56 of the images, the ruler itself was found but the ``2'' and/or the ``3'' on it was not, so a scale calculation could not be performed, producing a 99.2\% success rate for being able to compute 
\verb|scale|.
...
\begin{verbatim}
Mean intensity in bounding box | Std | Count

dark: 153.94935240158566 | 15.526143315470392 | 1800
normal: 168.2924981358199 | 14.214506494349248 | 5186
bright: 177.68854540643952 | 12.401282979349904 | 242
\end{verbatim}
\begin{verbatim}
